    ...
    */
	...
	$agreeCookies = $this->params->get('agreeCookies', '');
        ...
        if ( $app->getClientId() === 0 ) {			
            ...
            $strOutputHTML .= '<p style="padding:4px;">'. JText::_($message) .'<button class="' . $button_style . '">' . JText::_($buttomText) . '</button> <a href="' . JText::_($URLLegal). '" target="_blank">' . JText::_($urlLegalText) . '</a></p>';
            if($agreeCookies == 'Yes' ) {
